package com.louis296.carsalebbsservice.aspect;

import com.auth0.jwt.JWT;
import com.auth0.jwt.JWTVerifier;
import com.auth0.jwt.algorithms.Algorithm;
import com.auth0.jwt.interfaces.DecodedJWT;
import com.louis296.carsalebbsservice.CarSaleBbsServiceApplication;
import com.louis296.carsalebbsservice.mapper.UserMapper;
import com.louis296.carsalebbsservice.model.dao.User;
import com.louis296.carsalebbsservice.model.resp.ErrorData;
...
public class LoginAspect {
    ...
    @Around("execution(* com.louis296.carsalebbsservice.controller..*.*(..))  ")
    public Object doLoginCheck(ProceedingJoinPoint joinPoint) throws Throwable{
        ...
        try{
            ...
            JWTVerifier jwtVerifier= JWT.require(Algorithm.HMAC256(CarSaleBbsServiceApplication.secret)).build();
